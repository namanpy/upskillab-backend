...
import { Teacher, TeacherDocument } from '../../schemas/teacher.schema';
import { CreateTeacherDto, GetTeacherRequestDTO, UpdateTeacherDetailsDTO } from '../../dto/teacher.dto';
import { User, UserDocument } from '../../schemas/user.schema';
import { USER_TYPES } from '../../common/constants/user.constants';
...
export class TeacherDataService {
  ...
  async getTeacherByUserId(userId: string): Promise<PopulatedTeacherDocument | null> {
    const teacher = await this.teacherModel
  ...
  async updateTeacherByUserId(
    ...
    const teacherData = {
      ...
      ...(updateTeacherDto.social_links && { social_links: updateTeacherDto.social_links }),
      ...(updateTeacherDto.bio && { bio: updateTeacherDto.bio }),
      ...(updateTeacherDto.experience && { experience: updateTeacherDto.experience }),
    };
