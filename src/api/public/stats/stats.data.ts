...
export class StatsDataService {
  ...
  async updateStats(id: string, updateStatsDto: Partial<CreateStatsDto & { imageUrl: string }>): Promise<StatsDocument | null> {
    return this.statsModel.findByIdAndUpdate(id, updateStatsDto, { new: true }).exec();
  }
