...
//     const mobileNumber = orders.length > 0 ? orders[0].mobileNumber : undefined;
...
//       const orders = await this.orderDataService.getOrdersByUser(user._id);
//       if (orders.length > 0) {
//         const updatedOrder = await this.orderDataService.updateOrder(orders[0]._id.toString(), {
...
//     } else {
//       const orders = await this.orderDataService.getOrdersByUser(user._id);
//       mobileNumber = orders.length > 0 ? orders[0].mobileNumber : undefined;
//     }
